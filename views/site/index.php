...
<div class="main-content">
    <div class="container">
        <div class="row">
            <div id="myCarousel" class="carousel slide cont-wrap" data-ride="carousel">
                <!-- Indicators -->
                ...
                <?php foreach ($news[$category->id] as $article):?>
                    ...
                    <div class="post-content">
                        <header class="entry-header text-center text-uppercase">
                            <h6>Article of: <a href="<?= Url::toRoute(['site/category', 'id'=>$article->category->id]) ?>"><?= $article->category->title; ?></a></h6> 
